...
addSubDAO addsubdao = new addSubDAO();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        //processRequest(request, response);
       addsub.setSubClassificationId(request.getParameter("subClassificationId"));
       addsub.setSubClassificationName(request.getParameter("subClassificationName"));
       addsub.setMainClassificationId(request.getParameter("mainClassificationId"));
       
    try {
        addsubdao.saveSub(addsub);
